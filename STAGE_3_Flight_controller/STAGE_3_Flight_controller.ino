...
void setup(){
  ...
  DDRC |= B11110000;                                                        //Configure digital poort 4, 5, 6 and 7 as output.
  //DDRB |= B00110000;                                                        //Configure digital poort 12 and 13 as output.
  pinMode(41, OUTPUT);
  pinMode(42, OUTPUT);
  pinMode(43, OUTPUT);
  //Use the led on the Arduino for startup indication.
  digitalWrite(43,HIGH);                                                    //Turn on the warning led.
  ...
  for (cal_int = 0; cal_int < 1250 ; cal_int ++){                           //Wait 5 seconds before continuing.
    PORTC |= B11110000;                                                     //Set digital poort 4, 5, 6 and 7 high.
    delayMicroseconds(1000);                                                //Wait 1000us.
    PORTC &= B00001111;                                                     //Set digital poort 4, 5, 6 and 7 low.
    delayMicroseconds(3000);                                                //Wait 3000us.
  }

  //Let's take multiple gyro data samples so we can determine the average gyro offset (calibration).
  for (cal_int = 0; cal_int < 2000 ; cal_int ++){                           //Take 2000 readings for calibration.
    if(cal_int % 15 == 0)digitalWrite(43, !digitalRead(43));                //Change the led status to indicate calibration.
  ...
  while(receiver_input_channel_3 < 990 || receiver_input_channel_3 > 1020 || receiver_input_channel_4 < 1400){
    ...
    if(start == 125){                                                       //Every 125 loops (500ms).
      digitalWrite(43, !digitalRead(43));                                   //Change the led status.
  ...
  digitalWrite(43,LOW);                                                     //Turn off the warning led.
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Main program loop
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void loop(){
  ...
  if(battery_voltage < 1000 && battery_voltage > 600)digitalWrite(41, HIGH);
  ...
  if(micros() - loop_timer > 4050)digitalWrite(43, HIGH);                   //Turn on the LED if the loop time exceeds 4050us.
